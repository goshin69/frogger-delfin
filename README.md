...
Misiones de Conservación: Juega como un cangrejo, enfrenta desafíos reales como limpiar la basura y plásticos. Toma el rol de un buzo que tiene como objetivo rescatar animales marinos atrapados en redes de pesca o educar a otros sobre los peligros de la contaminación.
...
El personaje comienza con máxima vida, representada por un indicador que muestra “la vida del personaje” (depende de la dificultad).
Cada vez que el personaje choca con un obstáculo (basura, contaminación, colisión, pérdida de tiempo, fallo de misión) la vida se reduce, quizás de “4 → 3” “3 → 2” “2 → 1”.
